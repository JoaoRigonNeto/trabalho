dados = [
    ...
    ['Chevrolet','Chevette SL','alcool',4,'sedan',72,5600,7.4,11,7341],
    ['Fiat','147', 'alcool',2,'wagon',60,5200,7.3,11,2299],
    ['Chevrolet','Opala Diplomata AT','alcool',4,'sedan',135,4000,4.4,6.5,16354],
    ['Nissan', 'GT-R Premium','gas',2,'coupe',572,6800,6.1,8.2,948756],
    ['Volkswagen','Fusca','gas',2,'sedan',46,4600,8,12,23246],
    ['Ford','Galaxie 500','gas',4,'sedan',164,4400,4,6,88881],
    ['Volkswagen','Brasilia LS','gas',2,'hatch',65,4600,9,11,15803],
    ['Chevrolet','Camaro SS','gas',2,'coupe',461,6000,6.4,9.4,475890],
    ['Volkswagen','Gol GL','alcool',2,'hatch',96,5200,7.5,11.8,13367],
    ['Chevrolet','Celta','flex',4,'hatch',78,5000,9.5,12.2,35841],
]
